# Generated by Django 3.2 on 2024-06-24 08:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('reports', '0006_auto_20240624_1400'),
    ]

    operations = [
        migrations.CreateModel(
            name='payment_master_tbl',
            fields=[
        ...
        migrations.AlterField(
            ...
            name='receipt_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='references', to='reports.payment_master_tbl'),
        ),
        migrations.DeleteModel(
            name='Tblpayment_master',
        ),
    ]
